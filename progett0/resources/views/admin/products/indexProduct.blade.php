      ...
      <div class="row">
        <div class="col">
          <div class="mb-3 row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
              <input name="specie" value="{{ old('specie') }}" type="text" class="form-control">
            </div>
          </div>
        </div>
        <div class="col">
          <div class="mb-3 row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
              <select class="form-select" name = "ambiente" id = "ambiente">
                <option selected value="caldo">Caldo</option>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $product["name"] }}</td>
            <td>
              <a class="btn btn-primary" href="{{route('admin.products.edit' , $product->getId())}}">modifica</a>
            </td>
